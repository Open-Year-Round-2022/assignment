...
<head>
    ...
    <link rel="stylesheet" href="../css/feed_more_modal.css">
    <link rel="stylesheet" href="../css/feed_detail_modal.css">
</head>
...
<body>
            ...
            <section class="inner">
                <h1 class="logo">
                    ...
                    <a href="mainPage.html">
                        <img src="../images/logo_text.png" class="insta_logo" alt="">
                    </a>
                </h1>
                    ...
                    <div class="story">
                        <ul class="story_list">
                            <li>
                                <div class="sub_story">
                                    <div class="story_userId">
                                        <img src="../images/profile_img2.jpg" alt="프로필">
                                        <span>kihoonyou</span>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="sub_story">
                                    <div class="story_userId">
                                        <img src="../images/인스타기본프사.png" alt="프로필">
                                        <span>user2</span>
                                    </div>
                                </div>
                            </li>
                        ...
                        <div class="friend_container">
                            <div class="friend">
                                <div class="user_profile_box">
                                    <img src="../images/calmdownman.jpg" alt="친구프로필">
                                </div>
                            ...
                            <div class="friend">
                                <div class="user_profile_box">
                                    <img src="../images/인스타기본프사.png" alt="친구프로필">
                                </div>
                                <div class="user_profile_main_box">
                                    <div class="user_profile_id_box">
    ...
    <div class="feed_detail_modal" data-id="">
            ...
            <div class="feed_detail_right_container">
                ...
                <div class="detail_right_footer">
                    <div class="feed_bottom_icons">
                        <div class="left_icons">
                            ...
                            <div class="airplane_icon">
                                <img src="../images/종이비행기.png" alt="">
                            </div>
                        </div>

                        <div class="right_icon">
                            <img src="../images/bookmark.png" alt="" data-clicked="0" class="bookmark_img">
                        </div>
                    </div>
                    ...
                    <div class="comment_field">
                        ...
                        <input id="comment_text" type="text" placeholder="댓글달기...">
                        <div id="comment_btn" class="upload_btn">게시</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="feed_detail_modal_close">
        <img src="../images/창닫기.png" alt="">
    </div>
    </div>

    <script type="module" src="../js/mainPageEvent.js"></script>
    <script src="../js/feed_more_modal.js"></script>
    <script src="../js/feed_detail_modal.js"></script>
...
`;
    ...
    feed_post: (userid, userimg, name, postimg, text, likes) => {
        return `
        ...
        <div class="contents">
            ...
            <div class="img_section">
                <div class="trans_inner">
                    <div>
                        <img src="${postimg}" alt="피드게시물" class="feed_img">
                    </div>
                </div>
            </div>
            ...
            <div class="likes_text">
                좋아요 <p class="likes">${likes}</p>개
            </div>
